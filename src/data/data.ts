...
export const categories = [
  ...
  { id: 'workplace-efficiency', name: 'Workplace Efficiency' },
];

export const authors = [
  { id: 'hasan-Shanawar', name: 'Hasan Khan, Software Engineer' },
  { id: 'sufiyan-malik', name: 'Sufiyan Malik, Productivity Specialist' },
];
